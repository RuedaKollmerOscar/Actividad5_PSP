...
// Ejercicio 4
// Agrega una fecha personalizada al crear un usuario
exports.addCustomDateOnCreate = functions.firestore
  ...
  .onCreate(async (snapshot, context) => {
    try {
      ...
      // Actualizar el documento con la fecha de creación
      ...
      // Manejar errores al agregar la fecha de creación
...
// Ejercicio 5
// Guarda elemento eliminado con fecha personalizada
